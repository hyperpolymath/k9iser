...
// Replace k9iser, K9Iser — See README.adoc for details., just run, K9Iser started successfully. with actuals
= k9iser — Quick Start for Users
:toc:
:toclevels: 2

== What is k9iser?

K9Iser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./k9iser-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/k9iser/wiki
