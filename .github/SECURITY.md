...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/k9iser/security/advisories/new)
...
- This repository (`hyperpolymath/k9iser`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/k9iser/security/advisories)
...
- [Security Advisories](https://github.com/hyperpolymath/k9iser/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/k9iser/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/k9iser/discussions) |
