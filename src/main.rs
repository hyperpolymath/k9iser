...
enum Commands {
    ...
    Validate { #[arg(short, long, default_value = "k9iser.toml")] manifest: String },
    /// Generate K9 wrapper, Zig FFI bridge, and C headers.
    Generate {
        #[arg(short, long, default_value = "k9iser.toml")] manifest: String,
        #[arg(short, long, default_value = "generated/k9iser")] output: String,
    },
    /// Build the generated artifacts.
    Build { #[arg(short, long, default_value = "k9iser.toml")] manifest: String, #[arg(long)] release: bool },
    /// Run the workload.
    Run {
        #[arg(short, long, default_value = "k9iser.toml")] manifest: String,
    ...
    Info { #[arg(short, long, default_value = "k9iser.toml")] manifest: String },
}
